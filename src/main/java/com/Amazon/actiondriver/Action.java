...
import com.Amazon.Base.BaseClass;
	...
	public class Action extends BaseClass {
		 ...
		 * 
		 *  locator     : Action to be performed on element (Get it from Object
		 *                    repository)
		 * 
		 *  index       : Index of value wish to select from dropdown list.
		 * 
		 *  locatorName : Meaningful name to the element (Ex:Year Dropdown, items
		 *                    Listbox etc..)
		 * 
		 */
		 ...
		 *                    repository)
		 * 
		 * value       : Value wish to select from dropdown list.
		 * 
		 *  locatorName : Meaningful name to the element (Ex:Year Dropdown, items
		 *                    Listbox etc..)
		 */
		 ...
		 *                    repository)
		 * 
		 * visibletext : VisibleText wish to select from dropdown list.
		 * 
		 * locatorName : Meaningful name to the element (Ex:Year Dropdown, items
		 *                    Listbox etc..)
		 */
